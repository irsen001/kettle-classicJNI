...
//	private ImageView chatHead;
	...
	private long tmove,tclick,delta;
	...
	//	chatHead.setImageResource(R.drawable.circle_draw);
	//	chatHead.setText("abc");
		chatHead.setBackgroundResource(R.drawable.cir_50);
		//chatHead.setBackground(View);
		...
		chatHead.setOnClickListener(new OnClickListener() {
			...
			/*	 LayoutInflater layoutInflater   = (LayoutInflater)getBaseContext()
				...
				tclick = SystemClock.uptimeMillis();
				delta = tclick - tmove;
				//if (delta < 1*500){
					Log.v(TAG, "onclick float");
			...
			chatHead.setOnTouchListener(new View.OnTouchListener() {
				...
				@Override public boolean onTouch(View v, MotionEvent event) {
					...
					case MotionEvent.ACTION_MOVE:
						//tmove = SystemClock.uptimeMillis();
